# Generated by Django 3.1.4 on 2020-12-15 02:50
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('threshold_price', models.DecimalField(blank=True, decimal_places=2, max_digits=20, null=True)),
                ('current_passenger', models.PositiveIntegerField(blank=True, default=0, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('line_id', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='hibus.line')),
                ('user_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='hibus.customuser')),
            ],
        ),
        migrations.AddField(
            model_name='bus',
